...
//  Replace null values in each character's `images` object with
//  actual image paths, e.g. images: { radiant: '/characters/david-radiant.png' }
//  Images should be 300×300px PNG with transparent or white background.
//  Placeholders render styled SVG cards until real images are provided.
// ─────────────────────────────────────────────────────────────
...
export const CHARACTERS = [
  {
    ...
    accentColor: '#E8A838',
    // Replace these null values with image paths when ready
    images: {
